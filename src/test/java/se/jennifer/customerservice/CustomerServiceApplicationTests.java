package se.jennifer.customerservice;
...
import se.jennifer.customerservice.controller.CustomerController;
...
class CustomerControllerTest {
    ...
    void createCustomer_shouldReturnCreatedCustomer() throws Exception {
        ...
        mockMvc.perform(post("/customers")
                ...
                .andExpect(jsonPath("$.lastName").value("Viklund"))
                .andExpect(jsonPath("$.email")
                        .value("marcus.viklund@gmail.com"))
